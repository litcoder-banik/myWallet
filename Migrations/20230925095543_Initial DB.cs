        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CatagoryName = table.Column<string>(type: "nvarchar(8)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserCatagories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserCatagories_Catagories_CatagoryId",
                        column: x => x.CatagoryId,
                        principalTable: "Catagories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserCatagories_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserCatagories_CatagoryId",
                table: "UserCatagories",
                column: "CatagoryId");

            migrationBuilder.CreateIndex(
                name: "IX_UserCatagories_UserId",
                table: "UserCatagories",
                column: "UserId");
        }
